			...
			case 2 :
				...
				switch (__choice) {
					case 1 :
						...
						printf("\n\n\n\t\t\tid_card \t lastname \t firstname \t amount\n\n");
...
bool Loyalty() {
	...
	for (i = 0 ; i < 3 ; i++)
		Tab_C[i].amount += (Tab_C[i].amount * 1.3) / 100;

	cleanCls();
	printf("1.3 %% of Loyalty wase added to The first three accounts successfully");
}
...
//**************************************Main Menu********************************************************************/
	...
	do {
        printf("\t\t \n\n");
        printf("\t\t welcome to youcode bank \n\n");
        printf("\t\t \n\n");
